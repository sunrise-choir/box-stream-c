...
// TODO add in-place version of this
// If this returns true, it decrypts a received header into `plain_header`.
// Returns false if the cyper_header was invalid.
bool decrypt_header(
...
// TODO check whether all terminology is consistent
